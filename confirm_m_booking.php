  ...
  <?php
    ...
    */
    ...
    $orderData = [
        ...
        'amount' => $men_data['price'] * 100, // Convert to paise
        'currency' => 'INR',
        ...
        <?php 
          ...
          echo<<<data
            <div class="card p-3 shadow-sm rounded border-0">
              <img src="$men_thumb" class="img-fluid rounded mb-3">
          ...
          <div class="card-body me-0">
            <form action="#" id="booking_form" method="POST">
              ...
              <div class="row">
                ...
                <input type="hidden" name="category" value="men"> <!-- Change dynamically -->
              </div>
            </form>
          </div>
        </div>
...
<script>
  document.getElementById("payNow").addEventListener("click", function(e) {
      ...
      formData.append("product_id", "<?php echo $_SESSION['men']['id']; ?>");
      formData.append("order_id", "<?php echo $order['id']; ?>");
      formData.append("trans_amt", "<?php echo $_SESSION['men']['price']; ?>");

      var options = {
          "key": "<?php echo $apiKey; ?>",
          "amount": "<?php echo $_SESSION['men']['price'] * 100; ?>",
          "currency": "INR",
          "name": "ETERNA",
