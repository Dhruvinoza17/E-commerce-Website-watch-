...
<body>
  ...
  <?php
    ...
    */
    ...
    $_SESSION['smartwatch'] = [
      "id" => $smartwatch_data['id'],
      "name" => $smartwatch_data['name'],
      "price" => $smartwatch_data['price'],
      "payment" => null,
      "available" => false,
    ];
    ...
    $orderData = [
        ...
        'amount' => $smartwatch_data['price'] * 100, // Convert to paise
        'currency' => 'INR',
        ...
        <?php 
          ...
          echo<<<data
            <div class="card p-3 shadow-sm rounded border-0">
              <img src="$smartwatch_thumb" class="img-fluid rounded mb-3">
              <h6 class="mb-2" style="font-size: 23px;">$smartwatch_data[name]</h6>
              <p class="fw-bold mb-2" style="font-size: 1.2rem;">₹$smartwatch_data[price]/-</p>
            </div>
          data;
          ...
          <div class="card-body me-0">
            <form action="#" id="booking_form" method="POST">
              ...
              <div class="row">
                ...
                <input type="hidden" name="category" value="smartwatch"> <!-- Change dynamically -->
              </div>
            </form>
          </div>
        </div>
...
<script>
  document.getElementById("payNow").addEventListener("click", function(e) {
      ...
      formData.append("product_id", "<?php echo $_SESSION['smartwatch']['id']; ?>");
      formData.append("order_id", "<?php echo $order['id']; ?>");
      formData.append("trans_amt", "<?php echo $_SESSION['smartwatch']['price']; ?>");

      var options = {
          "key": "<?php echo $apiKey; ?>",
          "amount": "<?php echo $_SESSION['smartwatch']['price'] * 100; ?>",
          "currency": "INR",
          "name": "ETERNA",
