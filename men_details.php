        ...
        <div class="card border-0 shadow-sm rounded-3">
          <div class="card-body me-0">
            <?php 
              ...
              // Product price
              echo<<<price
                <p class="fw-bold mb-2" style="font-size: 1.2rem;">₹$men_data[price]/- $stock_status</p>
              price;
              ...
              if (!$settings_r['shutdown']) {
                ...
                if ($men_data['quantity'] > 0) {
                    ...
                    $book_btn = "<button onclick='checkLoginToBook($login, $men_data[id])' class='btn btn-sm btn-outline-dark w-100 shadow-none mb-2 mb-lg-0'> Buy Now </button>";
                } else {
