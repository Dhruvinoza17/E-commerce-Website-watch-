...
<head>
    ...
    <title>ETERNA - COUPLE PRODUCTS</title>
...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 p-4 overflow-hidden ms-auto">
                <h3 class="mb-4">COUPLE</h3>

                <!-- Couple Product Section -->
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#add-couple">
                ...
                <!-- Couple Product Modal -->
                <div class="modal fade" id="add-couple" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="add_couple_form" autocomplete="off">
                ...
                <!-- Edit Product Modal -->
                <div class="modal fade" id="edit-couple" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="edit_couple_form" autocomplete="off">
                            <div class="modal-content">
                                <div class="modal-header">
                ...
                <!-- Couple Iages Modal -->
                <div class="modal fade" id="couple-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
    ...
    <script src="./scripts/couple.js"></script>
