...
<head>
    ...
    <title>ETERNA - WOMEN PRODUCTS</title>
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 p-4 overflow-hidden ms-auto">
                <h3 class="mb-4">WOMEN</h3>

                <!-- Women Product Section -->
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#add-women">
                ...
                <!-- Women Product Modal -->
                <div class="modal fade" id="add-women" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="add_women_form" autocomplete="off">
                ...
                <!-- Edit Product Modal -->
                <div class="modal fade" id="edit-women" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="edit_women_form" autocomplete="off">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="women_id">
                                    </div>
                ...
                <!-- Women Images Modal -->
                <div class="modal fade" id="women-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
