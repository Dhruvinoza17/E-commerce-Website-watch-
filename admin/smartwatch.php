...
<head>
    ...
    <title>ETERNA - SMARTWATCH PRODUCTS</title>
...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 p-4 overflow-hidden ms-auto">
                <h3 class="mb-4">SMARTWATCH</h3>

                <!-- Men Product Section -->
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#add-smartwatch">
                ...
                <!-- Men Product Modal -->
                <div class="modal fade" id="add-smartwatch" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="add_smartwatch_form" autocomplete="off">
                ...
                <!-- Edit Product Modal -->
                <div class="modal fade" id="edit-smartwatch" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="edit_smartwatch_form" autocomplete="off">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="smartwatch_id">
                                    </div>
                ...
                <!-- Men Iages Modal -->
                <div class="modal fade" id="smartwatch-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="table-responsive-lg" style="height: 350px; overflow-y: scroll;">
                                    <table class="table table-hover border text-center">
                                        ...
                                        <tbody id="smartwatch-image-data">
                                        </tbody>
                                    </table>
                                </div>
    ...
    <script src="./scripts/smartwatch.js"></script>
