...
<head>
    ...
    <title>ETERNA - SMARTWATCH DETAILS</title>
...
<body>
  ...
  <?php
    ...
    if (!isset($_GET['id'])) {
      redirect('smartwatch.php');
    }

    $data = filteration($_GET);

    $smartwatch_res = select("SELECT * FROM `smartwatch` WHERE `id`=? AND `status`=? AND `removed`=?",[$data['id'],1,0],'iii');

    if (mysqli_num_rows($smartwatch_res) == 0) {
      redirect('smartwatch.php');
    }

    $smartwatch_data = mysqli_fetch_assoc($smartwatch_res);
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 my-4 mb-4 px-4">
        <h2 class="fw-bold h-font" style="color: #c23737;"><?php echo $smartwatch_data['brand'] ?></h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">HOME</a>
          <span class="text-secondary"> > </span>
          <a href="smartwatch.php" class="text-secondary text-decoration-none">SMARTWATCH</a>
          <span class="text-secondary"> > </span>
        </div>
      </div>
        ...
        <div id="menCarousel" class="carousel slide carousel-fade">
          <div class="carousel-inner">
            <?php 
              ...
              $smartwatch_img = SMARTWATCH_IMG_PATH."thumbnail.jpg";
              $img_q = mysqli_query($con,"SELECT * FROM `smartwatch_images` 
              ...
              if (mysqli_num_rows($img_q) > 0) {
                ...
                while ($img_res = mysqli_fetch_assoc($img_q)) {
                  echo"
                    <div class='carousel-item $active_class'>
                      <img src='".SMARTWATCH_IMG_PATH.$img_res['image']."' class='d-block w-100 rounded'>
                    </div>";
                    $active_class='';
                }
                ...
                echo "<div class='carousel-item active'>
                  <img src='$smartwatch_img' class='d-block w-100'>
                </div>";
              }
        ...
        <div class="card border-0 shadow-sm rounded-3">
          <div class="card-body me-0">
            <?php 
              ...
              // Product name
              echo<<<name
                <h6 class="mb-2" style="font-size: 23px;">$smartwatch_data[name]</h6>
              name;

              // Product category
              echo<<<cat
                <p class="text-secondary mb-2" style="font-size: 0.8rem;">$smartwatch_data[category]</p>
              cat;
              ...
              // Product price
              echo<<<price
                <p class="fw-bold mb-2" style="font-size: 1.2rem;">₹$smartwatch_data[price]/- $stock_status</p>
              price;
              ...
              if (!$settings_r['shutdown']) {
                ...
                if ($smartwatch_data['quantity'] > 0) {
                    ...
                    $book_btn = "<button onclick='checkLoginToBook($login, $smartwatch_data[id])' class='btn btn-sm btn-outline-dark w-100 shadow-none mb-2 mb-lg-0'> Buy Now </button>";
                } else {
                ...
                <div class="accordion" id="accordionExample">
                  <div class="accordion-item">
                      ...
                      <div class="accordion-body">
                          <p class="mb-1" style="font-size: 0.8rem;">$smartwatch_data[description]</p>
                      </div>
                      </div>
                  </div>
                  <div class="accordion-item">
                      ...
                      <div class="accordion-body">
                          ...
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[brand]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Model Number </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[modelnumber]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Movement </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[movement]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Case Material </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[casematerial]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Strap Material </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[strapmaterial]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Dial Size </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[dialsize]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Water Resistance </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[waterresistance]</p>
                          <p class="mb-0" style="font-size: 0.8rem;">Warranty </p>
                          <p class="text-secondary mb-3" style="font-size: 0.8rem;">$smartwatch_data[warranty]</p>
                      </div>
                      </div>
                  </div>
                </div>
