  ...
  <?php
    ...
    */
    ...
    $orderData = [
        ...
        'amount' => $couple_data['price'] * 100, // Convert to paise
        'currency' => 'INR',
        ...
        <?php 
          ...
          echo<<<data
            <div class="card p-3 shadow-sm rounded border-0">
              <img src="$couple_thumb" class="img-fluid rounded mb-3">
              <h6 class="mb-2" style="font-size: 23px;">$couple_data[name]</h6>
              <p class="fw-bold mb-2" style="font-size: 1.2rem;">₹$couple_data[price]/-</p>
            </div>
          data;
          ...
          <div class="card-body me-0">
            <form action="#" id="booking_form" method="POST">
              ...
              <div class="row">
                ...
                <input type="hidden" name="category" value="couple"> <!-- Change dynamically -->
              </div>
            </form>
          </div>
        </div>
...
<script>
  document.getElementById("payNow").addEventListener("click", function(e) {
      ...
      formData.append("product_id", "<?php echo $_SESSION['couple']['id']; ?>");
      formData.append("order_id", "<?php echo $order['id']; ?>");
      formData.append("trans_amt", "<?php echo $_SESSION['couple']['price']; ?>");

      var options = {
          "key": "<?php echo $apiKey; ?>",
          "amount": "<?php echo $_SESSION['couple']['price'] * 100; ?>",
          "currency": "INR",
          "name": "ETERNA",
